    ...
    private void rma_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rma_buttonActionPerformed
        ...
        try {
            ...
            if (flag == 1) {
                ...
                success_fail_msg = "select count(*) from estate where a_id=" + aid + ";";
                rs = stmt.executeQuery(success_fail_msg);
                while (rs.next()) {
                    if (rs.getInt(1) == 0) {
                        flag2 = 1;
                    }
                ...
                if (flag2 == 1) {
                    ...
                    CantRemoveAgent cra = new CantRemoveAgent();
                    cra.setVisible(true);
                    cra.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
                    this.dispose();
                }
